...
//go:generate go run github.com/upbound/upjet/cmd/scraper -n AviatrixSystems/terraform-provider-aviatrix -r ../.work/AviatrixSystems/aviatrix/docs/resources -o ../config/provider-metadata.yaml
